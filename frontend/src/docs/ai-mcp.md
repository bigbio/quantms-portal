...
<svg viewBox="0 0 900 280" width="900" height="280" preserveAspectRatio="xMidYMid meet" role="img" aria-labelledby="qp-mcp-title qp-mcp-desc" style="width:100%;height:auto;max-width:900px;display:block;margin:0 auto;color:var(--text-primary);">
